...
<Navbar />
  ...
  <div className="order-section-two-container">
                    ...
                    {trainer && trainer.filter((e) =>
                        ...
                        <div key={e._id}  className="col-sm-6 col-lg-3 mb-4">
                            <div className="cardtwo" style={{ border: '1px solid #ddd', backgroundColor: 'rgb(130, 230, 143)' }}>
                                {/* Display profile picture */}
                                <img src={profilePicture} alt={e.full_name} className="card-img-top" />
